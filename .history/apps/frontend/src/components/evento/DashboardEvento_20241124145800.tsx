	...
	return (
		<div className="flex flex-col gap-2">
			...
			<div className="grid grid-cols-3 gap-6 mt-4">
				...
				<Estatistica texto="Confirmações:" valor={props.presentes.length} imagem="/icones/confirmados.svg" />
			...
			<span className="flex py-2 text-xl font-bold text-white/80">Convidados que confimaram PRESENÇA</span>
